...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
       ...
       // UserDefaults.standard.synchronize()
        ...
        UILabel.appearance().font = Util.getLightFont(size: 16);
        UIButton.appearance().titleLabel?.font = Util.getLightFont(size: 16);
        
        let attr = NSDictionary(object: Util.getLightFont(size: 16), forKey: NSAttributedStringKey.font as NSCopying)
